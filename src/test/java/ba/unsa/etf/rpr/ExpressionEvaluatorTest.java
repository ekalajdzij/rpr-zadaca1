...
public class ExpressionEvaluatorTest {
    ...
    public void testIzuzetak() {
        ...
        assertThrows(RuntimeException.class,()->testiranje.evaluate("(1 + ( 2 * 3) /6)"));
        assertThrows(RuntimeException.class,()->testiranje.evaluate("(1 + ( 2 * 3)  2 sqrt 2)"));
        assertThrows(RuntimeException.class,()->testiranje.evaluate(""));
        assertThrows(RuntimeException.class,()->testiranje.evaluate("( 3 + sqrt (3) )"));
        assertThrows(RuntimeException.class,()->testiranje.evaluate(" ( sqrt 15 ) "));
